...
const StudentSignUp = () => {
  ...
  const handleEnrollChange = async (event) => {
    ...
    setEnrollError(!/^\d{14}$/.test(value));
    setIsformFilled(
      value !== "" &&
        password !== "" &&
        // phone !== "" &&
    ...
    // Check if Enrollment number input length is 14
    if (value.length === 14) {
   
      try {
        const enrollmentNumber = Number(value);
        ...
        //   // Handle API error response
        //   console.error(
        //     "Failed to verify Enrollment number:",
        //     response.statusText
        //   );
        //   alert("Failed to verify Enrollment number. Please try again.");
        // }
      } catch (error) {
        // setPopupMessage(error.message);
        // setalertLottie(ErrorLottie);
        console.error("Error verifying Enrollment number:", error);
    ...
    <div className="Container overflow-hidden">
      ...
      <div className="Right pt-5">
        <form className="Form pt-5">
          <div className="Heading">Student Signup</div>
          <div
          ...
          {enrollError && (
            <span className="Error text-gray-600">
              * Please enter a 14-digit enrollment number.
            </span>
          )}
          <div
            ...
            <div className="flex flex-col">
              <div className="pt-3 flex">
                <span
                  ...
                  onClick={() => {
                    handleRedirects("/studentLogin");
                  }}
                >
                  Already have an account? 
                  <span className="text-5xl ml-2 text-blue-700">
                  Login
                    </span>                  
                </span>
